...
public class FrmListadoTrabajadores extends JFrame {
	...
	private final JLabel lblTituloListado = new JLabel("Listado de Trabajadores");
	...
	public FrmListadoTrabajadores() {
		...
		botonNuevo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					controller.CtrlTrabajadores.dialNuevoTrabajador();
		...
		botonEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.CtrlTrabajadores.eliminaTrabajador();
			}
		...
		botonEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.CtrlTrabajadores.dialEditarTrabajador();
		...
		botonInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					controller.CtrlTrabajadores.dialInfoTrabajador();
				} catch (SQLException e1) {
					e1.printStackTrace();
				}
			}
